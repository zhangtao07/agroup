define([], function() {
    ...
    constants.MAIN_URL = location.origin + "/editor/";
    ...
    constants.WELCOME_DOCUMENT_TITLE = "你好AGroup";
    ...
    constants.PDF_EXPORT_URL = '/' + group.name + "/md/pdfExport";
    constants.PDF_IMG_URL = "/editor/pdfToImage";
