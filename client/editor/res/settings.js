define([
    ...
    var settings = {
        ...
        pdfTemplate: [
            ...
            '<meta charset="utf-8">',
            '<title><%= documentTitle %></title>',
            '<link rel="stylesheet" href="http://agroup.baidu.com/editor/res-min/themes/base.css" />',
            '<script type="text/x-mathjax-config">',
            'MathJax.Hub.Config({ messageStyle: "none" });',
            '</script>',
            '<script type="text/javascript" src="http://agroup.baidu.com/editor/libs/MathJax/MathJax.js?config=TeX-AMS_HTML"></script>',
            '</head>',
