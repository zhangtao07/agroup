define([
    ...
    fileMgr.syncFromServer = function(file) {
        storage.synclist = storage.synclist || '';
        var gf = file.group + file.title;
        var index = _.indexOf(storage.synclist.split(';'), gf);
        if (index < 0) {
    ...
    eventMgr.addListener("onReady", function(file, url) {
